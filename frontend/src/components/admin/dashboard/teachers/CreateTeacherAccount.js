                    ...
                    <form onSubmit={createTeacherAcc} className='flex flex-col space-y-6 divide-y'>
                        <div className="flex flex-row">
                            ...
                            <div className="w-[70%] pl-6">
                                ...
                                <div className="mb-6">
                                    <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Email address <span className='text-red-500 font-bold'>*</span></label>
                            ...
                            <div className="w-[70%] pl-6">
                                <div className="grid gap-6 mb-6 md:grid-cols-2">
                                    <div>
                                        ...
                                        <input type="text" id="zoom_link" name="zoom_link" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter zoom link.." />
                                    </div>
                                    <div>
                                        <label htmlFor="zoom_id" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Zoom ID</label>
                                        <input type="text" id="zoom_id" name="zoom_id" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Enter zoom ID.."/>
                                    </div>
                                    <div>
