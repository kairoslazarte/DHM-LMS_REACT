...
const StudentLogin = () => {
    ...
    <div className="flex flex-col lg:flex-row min-h-screen bg-white h-screen">
        {/* Left Section */}
        <div className="w-full lg:w-1/2 p-6 sm:p-8 lg:p-12 flex flex-col sm:my-0 my-6 h-full">
        {/* Logo */}
            <div className="mb-8 lg:mb-20">
                <div className="flex items-center">
                <img className='h-14 mr-2' src="static/images/dhm-logo-sm.png" />
                <span className="text-lg sm:text-xl font-semibold text-gray-800">Discovery House Montessori of Quezon City</span>
                </div>
            </div>
            ...
            >
                <h1 className="text-xl pt-4 sm:pt-0 sm:text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 text-gray-900 text-center">Login as a Student</h1>
        ...
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-emerald-400 to-emerald-600 p-8 lg:p-12 flex flex-col items-center justify-center relative h-full">
            {/* Sign Up Content */}
            <div className="text-center text-white py-8 lg:py-0">
                <h2 className="text-3xl lg:text-4xl font-bold mb-4">Discovery House Montessori of Quezon City</h2>
                <p className="text-lg lg:text-xl mb-1 px-4">“Train up a child in the way he should go; even when he is old he will not depart from it.“</p>
                <span>Proverbs 22:6</span>
                {/* <span className="italic text-md">59 Adrian, Novaliches, Quezon City, 1121 Metro Manila</span> */}
                {/* <a 
