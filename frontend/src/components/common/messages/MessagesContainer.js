            ...
            {!selectedConversation ? (
                ...
                <div className="bg-yellow-50 h-[30rem] sm:h-[60rem] flex flex-col rounded-md shadow">
                    ...
                    <div className='bg-green-300 rounded-t-md px-4 py-2 mb-2'>
                        ...
                        <span className='text-gray-900 font-bold'>{selectedConversation?.first_name} {selectedConversation?.last_name}</span>
                    </div>
    ...
    return (
        <div className='flex items-center justify-center w-full h-full'>
            <div className='px-4 text-center sm:text-lg md:text-xl text-black font-semibold flex flex-col items-center gap-2'>
                <p>Welcome 👋 {authUser?.first_name} {authUser?.last_name} ❄</p>
